...
import com.stone.shopmanager.config.HBUTConfig;
import com.stone.shopmanager.manager.CookiesManager;
import com.stone.shopmanager.manager.JSONManager;
import com.stone.shopmanager.manager.LoginManager;
import com.stone.shopmanager.model.shop.User;
import com.stone.shopmanager.service.FixLoginService;
    ...
    public void loginByXiaoCai() {
        ...
        bu2.login(this, new SaveListener() {
            ...
            public void onSuccess() {
                ...
                // 更新用户状态
                LoginManager.getInstance().updUserState(User.USER_STATE_LOGIN);
