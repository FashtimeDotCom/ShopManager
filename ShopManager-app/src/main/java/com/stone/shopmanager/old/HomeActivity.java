package com.stone.shopmanager.old;
...
import com.stone.shopmanager.activity.AddNewsActivity;
...
public class HomeActivity extends Activity implements OnClickListener {
    ...
    private void lookUsers() {
        ...
        query.findObjects(this, new FindListener<User>() {
            ...
            public void onSuccess(List<User> object) {
                ToastUtils.showToast("查询用户成功：" + object.size());
                tvRes.setText(" ");
            ...
            public void onError(int code, String msg) {
                ToastUtils.showToast("查询用户失败：" + msg);
            }
        });
    }
    ...
    private void lookShops() {
        ...
        query.findObjects(this, new FindListener<Shop>() {
            ...
            public void onSuccess(List<Shop> object) {
                ...
                ToastUtils.showToast("查询成功：共" + object.size() + "条数据。");
                tvRes.setText(" ");
                ...
                while (iterator.hasNext()) {
                    ...
                    tvRes.setText(tvRes.getText() + shop.getObjectId()
                            + "\t\t\t" + shop.getName() + "\t\t\t"
                            + shop.getUser().getUsername() + "\t\t\t" + shop.getUpdatedAt()
                            + "\n");
                }
            }
            ...
            public void onSuccess(List<Good> object) {
                ...
                while (iterator.hasNext()) {
                    ...
                    tvRes.setText(tvRes.getText() + good.getObjectId()
                            + "\t\t\t" + good.getName() + "\t\t\t"
                            + good.getPrice() + "\t\t\t" + good.getShop().getName()
                            + "\t\t\t" + good.getUpdatedAt() + "\n");
                }
            }
    ...
    private void addShop() {
        Intent toAddShopActivity = new Intent(HomeActivity.this, SaveShopActivity.class);
